# Variation 2 — Legal Pro Design Spec

## Summary

- Visual character: Premium legal operations with dense analytics and sharper enterprise polish.
- Mobile concept: Modular discovery dashboard
- Desktop concept: Analytics tile board
- Best use: Admin, firm, compliance, and revenue-heavy workflows with stronger dashboard density.
- Reference blend: Uses enterprise precision from legal operations products and cleaner KPI structure from modern analytics dashboards.
...
- Primary button text (#FFFFFF) on primary background (#1d4ed8): 6.7:1
-->
