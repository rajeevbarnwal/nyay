# Variation 1 — Bharat First Design Spec

## Summary

- Visual character: Warm legal credibility with courtroom-ready operational speed.
- Mobile concept: Stacked daily command center
- Desktop concept: Three-column command room
- Best use: Lawyers, firms, and citizens who need trust, urgency, and operational clarity.
- Reference blend: Combines Clio's practical legal mobility with Niva's warmth and restrained fintech-style analytics.
...
<!--
Contrast Ratios:
- Primary text (#1f1c1a) on white (#FFFFFF): 16.9:1
- Secondary text (#4d433b) on white (#FFFFFF): 9.6:1
- Primary button text (#FFFFFF) on primary background (#0f766e): 5.5:1
-->
